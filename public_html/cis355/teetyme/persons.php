		...
		<body>
    		<div class="container">
            	...
            	<div class="row">
					...
					<p> <a href="create_persons.php" class="btn btn-success">Create</a><a id="home" class="btn btn-danger" href="home.php">Home</a></p>
                 ...
                 <tbody>
                  <?php
                   ...
                   foreach ($pdo->query($sql) as $row) {
                            ...
                            echo '<td> <a class="btn btn-info" href="read_persons.php?id='.$row['id'].'">Read</a>
                            <a class="btn btn-success" href="update_persons.php?id='.$row['id'].'">Update</a>
                            <a class="btn btn-danger" href="delete_persons.php?id='.$row['id'].'">Delete</a></td>';
                            echo '</tr>';
                   }
                   Database::disconnect();
                  ?>
...
<?php
    ...
    if ( !empty($_POST)) {
        ...
        if ($valid) {
            ...
            Database::disconnect();
            header("Location: index_persons.php");
        }
    }
?>
<!DOCTYPE html>
...
<span class="help-inline"><?php echo $emailError;?></span>
                      ...
                      <div class="form-actions">
                          ...
                          <a class="btn btn-danger" href="index_persons.php">Back</a>
                        </div>
                    </form>
                </div>
...
<body>
    <div class="container">
                ...
                <div class="span10 offset1">
                    ...
                    <form class="form-horizontal" action="update_persons.php?id=<?php echo $id?>" method="post">
                      <div class="control-group <?php echo !empty($nameError)?'error':'';?>">
                        <label class="control-label">Name</label>
                        <div class="controls">
                            <input name="name" type="text"  placeholder="Name" value="<?php echo !empty($name)?$name:'';?>">
