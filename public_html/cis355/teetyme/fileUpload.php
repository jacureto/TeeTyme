...
#    : mysql_real_escape_string(stripslashes ($_FILES['userfile'])));
  ...
  $con = mysql_connect('localhost','jacureto','601140') 
    or die(mysql_error());
  $db  = mysql_select_db('jacureto',$con);
  if($db)
  {
    $query = "INSERT INTO tt_imgs (name, size, type, content) ".
