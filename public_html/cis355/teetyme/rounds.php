        ...
        <table>
          <tr>
    		...
    		<div class="container">
            	...
            	<div class="row">
					<p> <a href="create_rounds.php" class="btn btn-success">Create</a><a id="home" class="btn btn-danger" href="home.php">Home </a> </p>
			...
			<body>
				<div class="container">
							...
							<div class="span10 offset1">
								...
								<form class="form-horizontal" action="update_rounds.php?id=<?php echo $id?>" method="post">
    <div class="list-right">
