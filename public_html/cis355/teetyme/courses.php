        ...
        <table>
          <tr>
    		...
    		<div class="container">
            	...
            	<div class="row">
					<p> <a href="create_courses.php" class="btn btn-success">Create</a><a id="home" class="btn btn-danger" href="home.php">Home</a> </p>
    ...
    if ( !empty($_POST)) {
       ...
       if (empty($email)) {
        ...
        if ($valid) {
            ...
            $sql = "INSERT INTO tt_courses (name,email,phone,address,city,state,zip,par01,par02,par03,par04,par05,par06,par07,par08,par09,par10,par11,par12,par13,par14,par15,par16,par17,par18) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
            $q = $pdo->prepare($sql);
...
?> <!DOCTYPE html> <html lang="en"> <head>
    ...
    <div class="container">
                <div class="span10 offset1">
                    ...
                    <form class="form-horizontal" action="create_courses.php" method="post">
                    ...
                    <div class="controls">
					 ...
					 <div class="control-group">
                      ...
                      <div class="form-actions">
                          ...
                          <a class="btn btn-danger" href="index_courses.php">Back</a>
                        </div>
                    </form>
                </div>
    </div> <!-- /container -->
 ...
 <div class="control-group">
    ...
    if ( !empty($_POST)) {
        ...
        if ($valid) {
            $pdo = Database::connect();
            $pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
            $sql = "UPDATE tt_courses set name = ?, email = ?, phone =?, address=?, city=?, state=?, zip=?, par01=?, par02=?, par03=?, par04=?, par05=?, par06=?, par07=?, par08=?, par09=?, par10=?, par11=?, par12=?, par13=?, par14=?, par15=?, par16=?, par17=?,par18=? WHERE id = ?";
            $q = $pdo->prepare($sql);
            $q->execute(array($name,$email,$phone,$address,$city,$state,$zip,$par01,$par02,$par03,$par04,$par05,$par06,$par07,$par08,$par09,$par10,$par11,$par12,$par13,$par14,$par15,$par16,$par17,$par18,$id));
            Database::disconnect();
            header("Location: index_courses.php");
        }
		    } else {
